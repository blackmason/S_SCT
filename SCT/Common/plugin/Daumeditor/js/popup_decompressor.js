...
(function() {
    ...
    (function() {
        ...
        Object.extend(g, {
            ...
            msie_quirks: g.msie && h.top.document.compatMode !== "CSS1Compat"
        });
        Object.extend(g, {
    ...
    var a = function() {
        ...
        var s = {
            getUrl: function(E, F) {
                ...
                var B = h.EditorJSLoader || opener && opener.EditorJSLoader || (PopupUtil && PopupUtil.getOpener()["EditorJSLoader"]);
                E = E.replace(/#host#path\/pages\//g, B.getPageBasePath());
                E = E.replace(/#host/g, z.txHost);
                E = E.replace(/#path\/?/g, z.txPath);
                E = E.replace(/#cdnhost/g, z.cdnHost);
                E = E.replace(/#cmnhost/g, z.cmnHost);
                for (var C in w) {
                    E = E.replace(new RegExp("#".concat(C), "g"), z[w[C]])
                }
                if (F) {
                    for (var D in F) {
                        E = E.replace(new RegExp("#".concat(D), "g"), F[D])
                    }
                }
                return E
            },
    ...
    Object.extend(k, {
        ...
        isTagName: function(r, e) {
            e = e.toUpperCase();
            return r && r.tagName === e
        },
    ...
    (function() {
        ...
        Object.extend(k, {
            ...
            prevNodeUntilTagName: function(v, w, u) {
                u = u.toUpperCase();
                if (w === 0) {
                    v = v.previousSibling
                } else {
    ...
    Object.extend(k, {
        EMPTY_BOGUS: (g.msie_quirks || g.msie && g.msie_ver < 11 ? "&nbsp;" : "<br>")
    });
    Object.extend(k, {
        EMPTY_PARAGRAPH_HTML: "<p>" + k.EMPTY_BOGUS + "</p>"
    });
    h.$tom = k;
    (function(e) {
        e.Util = {
    ...
    l.I.JobObservable = l.Faculty.create({
        ...
        removeJob: function(e, s) {
            ...
            if (!s) {
                ...
                for (var r = 0; r < this.jobObservers[e].length; r++) {
                    if (this.jobObservers[e][r] === s) {
                        this.jobObservers[e].splice(r, 1)
                    }
                }
            }
        },
